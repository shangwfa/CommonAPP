...
public class HeaderViewListAdapter implements WrapperListAdapter {
    ...
    public HeaderViewListAdapter(@Nullable ArrayList<ZrcListView.FixedViewInfo> headerViewInfos,
            @Nullable ArrayList<ZrcListView.FixedViewInfo> footerViewInfos, ListAdapter adapter) {
        mAdapter = adapter;
    ...
    private boolean areAllListInfosSelectable(@Nullable ArrayList<ZrcListView.FixedViewInfo> infos) {
        if (infos != null) {
