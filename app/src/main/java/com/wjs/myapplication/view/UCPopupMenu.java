...
import com.wjs.myapplication.adapter.BodyAdapter;
import com.wjs.myapplication.adapter.TitleAdapter;


import java.util.List;

@SuppressLint("ViewConstructor")
public class UCPopupMenu extends PopupWindow {
    ...
    public UCPopupMenu( Context context, List<String> titles,
        ...
        for (int i = 0; i < item_names.size(); i++) {
            bodyAdapter[i] = new BodyAdapter( item_names.get(i),
                    item_images.get(i),context);
        }
        ...
        linearLayout.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((keyCode == KeyEvent.KEYCODE_MENU)
                        && (UCPopupMenu.this.isShowing())) {
                    UCPopupMenu.this.dismiss();
