 ...
 *******************************************************************************/
package com.wjs.myapplication.view.library.extras;

import android.content.Context;
import android.util.AttributeSet;
import android.webkit.WebView;

import com.wjs.myapplication.view.library.PullToRefreshWebView;

import java.util.concurrent.atomic.AtomicBoolean;


/**
 * An advanced version of  which delegates the
