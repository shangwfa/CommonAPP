 ...
 */
public class SlidingMenuViewDragHelper extends FrameLayout {
    private static final String TAG = "SlidingMenuViewDragHelper";
    ...
    public SlidingMenuViewDragHelper(Context context) {
        this(context, null);
    }

    public SlidingMenuViewDragHelper(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingMenuViewDragHelper(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class sCallBack extends ViewDragHelper.Callback {
        ...
        public void onEdgeDragStarted(int edgeFlags, int pointerId) {
            mDragHelper.captureChildView(childViewA, pointerId);
        }
...
//            return resultLeft;
    ...
    public boolean onTouchEvent(MotionEvent ev)
    {
                ...
                ev.getAction() == MotionEvent.ACTION_CANCEL )
        {
            if(childViewA != null)
            {
                Logger.d("eventX:"+ev.getX());
                Logger.d("childViewA.getWidth():"+childViewA.getWidth());
