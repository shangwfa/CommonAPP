...
import com.wjs.myapplication.view.library.internal.FlipLoadingLayout;
import com.wjs.myapplication.view.library.internal.LoadingLayout;
import com.wjs.myapplication.view.library.internal.RotateLoadingLayout;
import com.wjs.myapplication.view.library.internal.Utils;
import com.wjs.myapplication.view.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public boolean isScrowTop = false;
    ...
    /* (non-Javadoc)
     * @see com.handmark.pulltorefresh.library.IPullToRefresh#setLocation(float, float)
     */
    public void setLocation(int x, int y) {
        mRefreshableView.scrollTo(x, y);
    }
