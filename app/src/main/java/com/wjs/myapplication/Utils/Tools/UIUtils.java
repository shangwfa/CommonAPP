...
import com.wjs.myapplication.view.PullToRefreshListView;
...
public class UIUtils {
     ...
     * @param key
     */
    public static void setPullToRefreshLastUpdated(Context context,PullToRefreshListView listView, String key) {
     ...
     * @param key
     */
    public static void savePullToRefreshLastUpdateAt(Context context,PullToRefreshListView listView, String key) {
